...
pip install git+ssh://git@github.com/lean-zone/mytest.git
```
...
```sh
# install from the production repo
pip install 'diting[aiohttp] @ git+ssh://git@github.com/lean-zone/mytest.git'
```
...
These methods return an [`APIResponse`](https://github.com/lean-zone/mytest/tree/main/src/diting/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/lean-zone/mytest/tree/main/src/diting/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/lean-zone/mytest/issues) with questions, bugs, or suggestions.
